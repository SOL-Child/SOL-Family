package com.authenticationservice.token.config;
...
public class TokenProvider {
    ...
    // 토큰 생성
    private String makeToken(Date expiy, User user) {
        Date now = new Date();
        ...
        return Jwts.builder()
                ...
                .setSubject(user.getPhone())   /* 토큰의 subject(토큰이 대상으로 하는 주체)를 설정 */
                .claim("identification", user.getId())
                .claim("auth", user.getUserType())   /*  JWT에 커스텀 클레임을 추가 */
