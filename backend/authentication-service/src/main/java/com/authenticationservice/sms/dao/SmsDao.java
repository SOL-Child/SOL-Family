package com.authenticationservice.sms.dao;
...
public class SmsDao {
    ...
    public void createSmsCertification(String phone, String certificationNumber) { //사용자가 입력한 휴대폰 번호와 인증번호를 저장하고 TTL을 3분으로 설정
